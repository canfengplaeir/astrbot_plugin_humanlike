...
class DebounceChecker:
    ...
    def check(self, state, current_time: float) -> bool:
        cooldown = float(self._dc.get("min_reply_cooldown", 25))
        ...
        max_msgs = int(self._dc.get("max_replies_per_window", 6))
        ...
        silence_prob = float(self._fc.get("random_silence_probability", 15.0))
